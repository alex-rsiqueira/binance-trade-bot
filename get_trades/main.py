...
def main(event, context):
    ...
    print('Start - Binance Trades Ingestion')

    try:
        print('Get Binance Accounts')
        binance_accounts = support.get_bincance_accounts()
        ...
        for user in binance_accounts:
            ...
            #user_id = user['UserID']
            app_key = user['Client_ID']
            app_secret = user['Client_Secret']
